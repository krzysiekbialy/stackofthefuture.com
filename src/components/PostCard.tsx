...
const PostCardStyles = css`
  ...
  margin: 0 20px 40px;
  min-height: 300px;
  background: ${lighten(0.05)(colors.darkgrey)} center center;
...
export interface PostCardProps {
  post: PageContext;
  videosInSeries?: number;
}

const PostCard: React.FC<PostCardProps> = ({ post, videosInSeries }) => {
  return (
    <article
    ...
    >
      ...
      <PostCardContent className="post-card-content">
        ...
        <PostCardMeta className="post-card-meta">
          ...
          {videosInSeries && <ReadingTime>{videosInSeries} videos in series</ReadingTime>}
        </PostCardMeta>
      </PostCardContent>
    </article>
  );
